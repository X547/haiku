...
void scsi_add_queued_request( ScsiCcbImpl *request );
void scsi_add_queued_request_first( ScsiCcbImpl *request );
void scsi_remove_queued_request( ScsiCcbImpl *request );


static inline void scsi_add_req_queue_first( ScsiCcbImpl *request )
{
	ScsiDeviceImpl *device = static_cast<ScsiDeviceImpl*>(request->device);

	SHOW_FLOW( 3, "request=%p", request );

	ADD_CDL_LIST_HEAD( request, ScsiCcbImpl, device->queued_reqs, );
}

static inline void scsi_add_req_queue_last( ScsiCcbImpl *request )
{
	ScsiDeviceImpl *device = static_cast<ScsiDeviceImpl*>(request->device);

	SHOW_FLOW( 3, "request=%p", request );

	ADD_CDL_LIST_TAIL( request, ScsiCcbImpl, device->queued_reqs, );
}

static inline void scsi_remove_req_queue( ScsiCcbImpl *request )
{
	ScsiDeviceImpl *device = static_cast<ScsiDeviceImpl*>(request->device);
...
static inline void scsi_add_device_queue_first( ScsiDeviceImpl *device )
{
	SHOW_FLOW0( 3, "" );
	...
	ADD_CDL_LIST_HEAD( device, ScsiDeviceImpl, device->bus->waiting_devices, waiting_ );
}

// ignored, if device is already queued
static inline void scsi_add_device_queue_last( ScsiDeviceImpl *device )
{
	SHOW_FLOW0( 3, "" );
	...
	ADD_CDL_LIST_TAIL( device, ScsiDeviceImpl, device->bus->waiting_devices, waiting_ );
}

// ignored, if device is not in queue
static inline void scsi_remove_device_queue( ScsiDeviceImpl *device )
{
	SHOW_FLOW0( 3, "" );
...
static inline void scsi_set_device_overflow( ScsiDeviceImpl *device )
{
...
// (multiple calls are ignored gracefully)
static inline void scsi_set_bus_overflow( ScsiBusImpl *bus )
{
...
// (multiple calls are ignored gracefully)
static inline void scsi_clear_device_overflow( ScsiDeviceImpl *device )
{
...
// (multiple calls are ignored gracefully)
static inline void scsi_clear_bus_overflow( ScsiBusImpl *bus )
{
...
static inline bool scsi_can_service_bus( ScsiBusImpl *bus )
{
...
static inline void scsi_unblock_bus_noresume( ScsiBusImpl *bus, bool by_SIM )
{
...
static inline void scsi_unblock_device_noresume( ScsiDeviceImpl *device, bool by_SIM )
{
...
// block bus
// lock must be hold
static inline void scsi_block_bus_nolock( ScsiBusImpl *bus, bool by_SIM )
{
	++bus->blocked[by_SIM];
	++bus->lock_count;
}
...
// block device
// lock must be hold
static inline void scsi_block_device_nolock( ScsiDeviceImpl *device, bool by_SIM )
{
	++device->blocked[by_SIM];
	++device->lock_count;
...
void scsi_block_bus( ScsiBusImpl *bus );
void scsi_unblock_bus( ScsiBusImpl *bus );
void scsi_block_device( ScsiDeviceImpl *device );
void scsi_unblock_device( ScsiDeviceImpl *device );

void scsi_cont_send_bus( ScsiBusImpl *bus );
void scsi_cont_send_device( ScsiDeviceImpl *device );
