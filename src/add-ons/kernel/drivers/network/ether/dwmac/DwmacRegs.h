...
union DwmacMacConfig {
	struct {
		...
		uint32 je:        1; // 16
		uint32 jd:        1; // 17
		uint32 unknown2:  1; // 18
		uint32 wd:        1; // 19
		uint32 acs:       1; // 20
		uint32 cst:       1; // 21
		uint32 unknown3:  1; // 22
		uint32 gpslce:    1; // 23
		uint32 unknown4:  8; // 24
	};
	uint32 val;
};
...
union DwmacRxqCtrl0 {
	struct {
		DwmacRxqCtrl0Rxq0en rxq0en:    2; //  0
		uint32              unknown1: 30; //  2
	};
	uint32 val;
};
...
union DwmacHwFeature1 {
	struct {
		...
		uint32 unknown1:    1; //  5
		uint32 txFifoSize:  5; //  6
		uint32 unknown2:   21; // 11
	};
	uint32 val;
};
...
union DwmacMdioAddr {
	struct {
		uint32           gb:        1; //  0
		uint32           c45e:      1; //  1
		DwmacMdioAddrGoc goc:       2; //  2
		uint32           skap:      1; //  4
		uint32           unknown1:  3; //  5
		DwmacMdioAddrCr  cr:        3; //  8
		uint32           unknown2:  5; // 11
		uint32           rda:       5; // 16
		uint32           pa:       11; // 21
	};
	uint32 val;
...
union DwmacMtlTxOpMode {
	struct {
		...
		uint32                unknown1: 12; //  4
		uint32                tqs:       9; // 16
		uint32                unknown2:  7; // 25
	};
	uint32 val;
};
...
union DwmacMtlRxDebug {
	struct {
		uint32 unknown1:  4; //  0
		uint32 rxqsts:    2; //  4
		uint32 unknown2: 10; //  6
		uint32 prxq:     15; // 16
		uint32 unknown3:  1; // 31
	};
	uint32 val;
};
