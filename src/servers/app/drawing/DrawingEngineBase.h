...
public:
	...
	virtual	void			DrawArc(BRect r, const float& angle,
								const float& span, bool filled, const BGradient& gradient) = 0;

	virtual	void			DrawBezier(BPoint* pts, bool filled) = 0;
	virtual	void			DrawBezier(BPoint* pts, bool filled, const BGradient& gradient) = 0;

	virtual	void			DrawEllipse(BRect r, bool filled) = 0;
	virtual	void			DrawEllipse(BRect r, bool filled, const BGradient& gradient) = 0;
	...
	virtual	void			StrokeRect(BRect rect, const BGradient& gradient) = 0;
	...
	virtual	void			DrawRoundRect(BRect rect, float xrad,
								float yrad, bool filled, const BGradient& gradient) = 0;
	...
	virtual	void			DrawTriangle(BPoint* points, const BRect& bounds,
								bool filled) = 0;
	virtual	void			DrawTriangle(BPoint* points, const BRect& bounds,
								bool filled, const BGradient& gradient) = 0;
